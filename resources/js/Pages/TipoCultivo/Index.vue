                ...
                <div class="md:grid md:grid-cols-4 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg text-gray-900">Listado de Tipos de Cultivos</h3>
                        </div>
                    </div>
                    <div class="md:col-span-3 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4">
                            <div class="flex justify-between items-center">
                                ...
                                <inertia-link :href="route('tipoCultivo.create')" class="bg-blue-500 hover:bg-blue-700 p-3 rounded font-bold text-white">
                                    Crear Tipo
                                </inertia-link>
                            </div>
                            <hr class="my-6">
                            <table class="border-collapse w-full">
                                ...
                                <tbody>
                                    <tr v-for="(tipo_cultivo,i) in tipo_cultivos.data" :key="i" class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                                        ...
                                        <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                                            ...
                                            <inertia-link class="text-blue-400 hover:text-blue-600 underline m-2" :href="route('tipoCultivo.edit',tipo_cultivo.id)">
                                                Editar
                                            </inertia-link>
                                            <a class="text-blue-400 hover:text-blue-600 underline m-2" href="#" @click="confirmDeleteData(tipo_cultivo.id)">
                                                Eliminar
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <pagination class="mt-6" :data="tipo_cultivos" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods : {
            ...
            deleteTipo(){
                ...
                Inertia.delete(this.route('tipoCultivo.destroy' , this.id), {
                    preserveScroll: true,
                    onSuccess: () => {
                        this.search = '';
                        this.closeModal();
        ...
        watch : {
            search : function (value) {
                this.$inertia.replace(this.route('tipoCultivo.index', {
                    search : value
                }));
            }
        }
