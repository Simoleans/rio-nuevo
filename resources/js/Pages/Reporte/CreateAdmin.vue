                            ...
                            <form @submit.prevent="storeData">
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="col-span-2">
                                        <jet-label for="operador" value="Operador (*)" />
                                        <Select2 required v-model="form.user_id" :options="usersOpt" :settings="{ dropdownAutoWidth: true,width: '100%' }"/>
    ...
    export default {
        ...
        setup(props) {
                ...
                props.users.forEach( function(element) {
                    usersOpt.push({'id' : element.id,'text' : element.name+' - '+element.email})
                });
                ...
                const storeData = () => {
                    if(form.value.h_anterior > form.value.hs_maquina){
                        ...
                        Inertia.post(route('storeAdmin'), {...form.value,...tipo.value})
                    }
                ...
                return {form,storeData,productorOpt,campoOpt,maquinaOpt,variedadOpt,tipo_cultivoOpt,copyKgTeorico,tipo,usersOpt}
        }
    }
