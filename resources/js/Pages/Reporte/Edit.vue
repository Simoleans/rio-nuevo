                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1">
                        <div class="px-4 sm:px-0">
                            <h3 class="text-lg text-gray-900">Editar Reporte</h3>
...
<script>
    ...
    export default {
        ...
        setup(props) {
                ...
                const form =  ref({
                    cuartel: props.reporte.cuartel,
                    variedad_id: props.reporte.variedad_id,
                    maquina_id: props.reporte.maquina_id,
                    campo_id: props.reporte.campo_id,
                    productor_id: props.reporte.productor_id,
                    tipo_cultivo_id: props.reporte.tipo_cultivo_id,
                    kg_totales : props.reporte.kg_totales,
                    kg_teoricos : props.reporte.kg_teoricos,
                    hs_maquina : props.reporte.hs_maquina,
                    observacion : props.reporte.observacion,
                    fecha : props.reporte.fecha,
                    fecha_mostrar :  props.reporte.fecha,
                    h_anterior : props.reporte.h_anterior,
                });

                const tipo =  ref({
                    tipo_bandeja35 : props.reporte.tipo_bandeja35,
                    tipo_bandeja7 : props.reporte.tipo_bandeja7,
                    tipo_bandeja14 : props.reporte.tipo_bandeja14,
                ...
                const storeData = () => {
                    if(form.value.h_anterior > form.value.hs_maquina){
                        ...
                        Inertia.put(route('reporte.update',props.reporte.id), {...form.value,...tipo.value})
                    }
