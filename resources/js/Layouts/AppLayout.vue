<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-blue-500 border-b border-gray-100 shadow-md">
            ...
            <!-- Page Content -->
            <main>
            <div v-if="$page.props.flash.message" :class="$page.props.flash.class" class="flex items-center text-white text-sm font-bold px-4 py-3" role="alert">
